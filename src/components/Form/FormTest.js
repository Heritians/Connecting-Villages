...
export default class FormTest extends Component {
  state = {
    //Table1*****************************
    respondents_name: "wef",
    respondents_gender: "fwe",
    respondents_age: "0",
    relation_w_hoh: "few",
    ...
    open_well2: "fwe",
    open_well3: "0",
    mode_of_water_storage: "fwe",
    other_water_source: "NA",

    //Table7*********************************

    electricity_conn: "few",
    ...
    appliances: [
      { appliance_name: "wef", appliance_nos: "0", appliance_dur: "0" },
    ],
    ...
    is_chemical_fertilizer_used2: "dfsd",
    is_chemical_fertilizer_used3: "0",
    is_chemical_insecticide_used2: "dfsd",
    is_chemical_insecticide_used3: "0",
    is_chemical_weedice_used2: "dfsd",
    is_chemical_weedice_used3: "0",
    is_chemical_organic_manures2: "dfsd",
    ...
    bullocks: "0",
    poultry_and_ducks: "0",
    livestock_shelter2: "dfsd",
    avg_daily_milk_prod_litres: "0",
    animal_waste_or_cow_dung_kgs: "0",

    //Table12*********************************

    major_problems: [{ problems: "dfsd", Suggestions_by_villagers: "dfsd" }],
  };
  ...
  handleSubmit = async (event) => {
    ...
    this.state.major_problems.map((item) => {
                  ...
                  <tbody>
                    ...
                    <TableRow>
                      <TableData colSpan={1}>
                        ...
                        <InputSelect name="id_type" onChange={this.getValue}>
                  ...
                  <tbody>
                    <TableRow>
                      ...
                      <TableData>
                        ...
                        <InputSelect onChange={this.getValue} name="hoh_gender">
                          <InputOption defaultValue="Select">
                            Select
                          </InputOption>
                    ...
                    <TableRow>
                      <TableData colSpan={2}>
                        ...
                        <InputSelect onChange={this.getValue} name="category">
                          <InputOption defaultValue="Select">
                            Select
                          </InputOption>
                      ...
                      <TableData colSpan={2}>
                        ...
                        <InputSelect onChange={this.getValue} name="pov_status">
                          <InputOption defaultValue="Select">
                            Select
                          </InputOption>
                    ...
                    <TableRow>
                      <TableData>
                        ...
                        <InputSelect onChange={this.getValue} name="own_house">
                          <InputOption defaultValue="Select">
                            Select
                          </InputOption>
                      ...
                      <TableData>
                        ...
                        <InputSelect onChange={this.getValue} name="house_type">
                          <InputOption defaultValue="Select">
                            Select
                          </InputOption>
                      ...
                      <TableData>
                        ...
                        <InputSelect onChange={this.getValue} name="toilet">
                          <InputOption defaultValue="Select">
                            Select
                          </InputOption>
                ...
                <Table>
                  ...
                  <tbody>
                    ...
                    <TableRow>
                      ...
                      <TableData>
                        <InputSelect onChange={this.getValue} name="hand_pump2">
                          <InputOption defaultValue="Select">
                            Select
                          </InputOption>
                          <InputOption value="Yes">Yes</InputOption>
                    ...
                    <TableRow>
                      ...
                      <TableData>
                        <InputSelect onChange={this.getValue} name="open_well2">
                          <InputOption defaultValue="Select">
                            Select
                          </InputOption>
                          <InputOption value="Yes">Yes</InputOption>
                  ...
                  <tbody>
                    ...
                    <TableRow>
                      <TableData>
                        ...
                        <InputSelect onChange={this.getValue} name="lighting1">
                          <InputOption defaultValue="Select">
                            Select
                          </InputOption>
                    ...
                    <TableRow>
                      <TableData>
                        ...
                        <InputSelect onChange={this.getValue} name="cooking1">
                          <InputOption defaultValue="Select">
                            Select
                          </InputOption>
                  ...
                  <tbody>
                    ...
                    <TableRow>
                      <TableData colSpan={3}>
                        ...
                        <InputSelect onChange={this.getValue} name="irrigation">
                          <InputOption defaultValue="Select">
                            Select
                          </InputOption>
